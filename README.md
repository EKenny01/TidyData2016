...
The run_analysis.R script in this repository performs the following functions:
...
* Creates a second, independent tidy data set with the average of each variable for each activity and code set. 
  This data set is named 'averages.txt'
